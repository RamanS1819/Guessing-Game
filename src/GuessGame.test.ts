...
describe('Test', () => {
  ...
  it('our test', async () => {
    ...
    // }).rejects.toThrow('Other number was guessed');
    ...
    // let checkProof1 = await CheckProgramm.check(
    //   checkProof1PublicInput,
    //   hiddenValue
    // );
    ...
    // let checkProof2 = await CheckProgramm.check(
    //   checkProof2PublicInput,
    //   hiddenValue
    // );
    ...
    // let checkProof3 = await CheckProgramm.check(
    //   checkProof3PublicInput,
    //   hiddenValue
    // );
    ...
    const curHiddenNumber = zkApp.hiddenNumber.get();
    const curScoreRoot = zkApp.scoreRoot.get();

    expect(curHiddenNumber).toEqual(Field(0));  // It should be updated after right guess
